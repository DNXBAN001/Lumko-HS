...
export default function About() {
    ...
    return (
        <div className="main-body">
            ...
            <div className="about-container w-full md:w-4/5 m-auto mt-12">
                <h1 className="text-3xl font-medium text-center">About us</h1>
                <div className="about-wrapper mt-12 md:flex md:justify-between md:items-center pt-12 px-2">
                    <div className="w-4/5 m-auto md:w-auto">
                        <Image src="/logo-large.png" width={250} height={250} alt="logo-img" /> 
                    </div>
                    <div className="about-content mt-12 md:mt-0 w-full md:w-3/5">
                        <p className="">
                ...
                <div className="mision-vision-values-wrapper my-12 md:flex md:justify-around px-2">
                    <div className="mission-wrapper w-full md:w-3/6">
                    ...
                    <div className="vision-mission-wrapper w-full md:w-2/6">
                        <div className="vision-wrapper mt-5 md:mt-0">
                        ...
                        <div className="about-values-wrapper mt-6">
