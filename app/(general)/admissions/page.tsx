        ...
        <div className="main-body">
            ...
            <div className="admissions-container w-4/5 m-auto mt-12 mb-16">
                ...
                <div className="application-info mt-12">
                    ...
                    <h3 className="how-to-apply text-xl text-center mt-12">How to apply?</h3>
                    <div className="steps-wrapper mt-10 md:flex md:justify-around pl-1">
                        <div className="step-wrapper w-full md:w-2/5">
                        ...
                        <div className="step-wrapper step-wrapper-even w-full md:w-2/5 mt-8 md:mt-0">
                    ...
                    <div className="steps-wrapper mt-8 md:flex md:justify-around pl-1">
                        <div className="step-wrapper w-full md:w-2/5">
                    ...
                    <div className="track-status-step  mt-8 md:flex md:justify-around pl-1">
                        <div className="step-wrapper step-wrapper-even w-full md:w-2/5">
