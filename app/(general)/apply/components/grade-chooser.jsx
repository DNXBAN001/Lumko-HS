        ...
        <form onSubmit={handleSubmit}>
            <div className="mt-12">
                ...
                <div className="mt-4">
                    ...
                    className='grade-input' value="8" checked={gradeApplyingFor.grade === "8"} 
                    onChange={handleChange} />
                    <label htmlFor="grade-8" className="pl-1">Grade 8</label>
                </div>
                <div className="mt-2">
                    <input type="radio" name="grade" id="grade-9" required
                    className='grade-input' value="9" checked={gradeApplyingFor.grade === "9"} 
                    onChange={handleChange} />
