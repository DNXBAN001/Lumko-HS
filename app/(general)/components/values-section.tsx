    ...
    return (
        <section className="values-section ">
            ...
            <div className="values-wrapper flex flex-wrap justify-between  w-4/5 m-auto mt-12 p-6">
                <div className="value-wrapper w-2/5 p-5">
                    <h3 className="text-xl pb-3">Cultural Diversity:</h3>
                    <p>
                ...
                <div className="value-wrapper w-2/5 p-5">
                    <h3 className="text-xl pb-3">Outstanding Academics:</h3>
                    <p>
                ...
                <div className="value-wrapper w-2/5 p-5">
                    <h3 className="text-xl pb-3">Dedicated Educators:</h3>
                    <p>
                ...
                <div className="value-wrapper w-2/5 p-5">
                    <h3 className="text-xl pb-3">Modern Infrastructure:</h3>
                    <p>
